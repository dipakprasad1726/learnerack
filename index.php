  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#signup"><span class="glyphicon glyphicon-user"/>SIGNUP</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      choose the best. </h4><br>
      <p>This is a new generation of education and we look forward to serve you the best through new technologies. We aim is to provide the best user experience.</p>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2>Our Values</h2><br>
      <h4><strong>MISSION:</strong> Time is priceless so we try to save most of our users time. We value our users time and try to help them by providing the most authentic information. </h4><br>
    </div>
  </div>
</div>
...
<script>
var myCenter = new google.maps.LatLng(12.97771, 77.5990963);
